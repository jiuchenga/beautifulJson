...
export default function WordCounter() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">Online Word Counter</h1>
        <p className="mt-1 text-sm text-[var(--text-secondary)]">Count characters, words, lines, paragraphs, and bytes in real-time.</p>
      </div>
